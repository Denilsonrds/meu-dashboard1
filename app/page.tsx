...
<button onClick={() => { const novaMeta = prompt("Definir nova meta mensal:", String(metaMensal)); if (novaMeta) setMetaMensal(Number(novaMeta)); }} className="text-blue-600 text-xs font-bold hover:underline">Ajustar Meta</button>        </div>
